...
?? Explicar que una vez hecha la correlación nos damos cuenta que las siguientes variables son las que más se correlacionan con la producción. Mostramos por un lado a la izquierda las variables y a su derecha la correlación con la producción.
...
write.table(trainetometeo_train_log_norm_corr1, 
  "data_pruebas/trainetometeo_train_log_norm_corr1.txt", 
  sep=",", dec=".", row.names=FALSE)
write.table(trainetometeo_test_log_norm_corr1, 
  "data_pruebas/trainetometeo_test_log_norm_corr1.txt", 
  sep=",", dec=".", row.names=FALSE)
...
write.table(trainetometeo_train_norm_simple, 
  "data_pruebas/trainetometeo_train_norm_simple.txt", 
  sep=",", dec=".", row.names=FALSE)
write.table(trainetometeo_test_norm_simple, 
  "data_pruebas/trainetometeo_test_norm_simple.txt", 
  sep=",", dec=".", row.names=FALSE)
write.table(trainetometeo_train_norm_simple2, 
  "data_pruebas/trainetometeo_train_norm_simple2.txt", 
  sep=",", dec=".", row.names=FALSE)
write.table(trainetometeo_test_norm_simple2, 
  "data_pruebas/trainetometeo_test_norm_simple2.txt", 
  sep=",", dec=".", row.names=FALSE)
```
...
# Finalmente, según la regresión lineal nos quedamos con el siguiente conjunto de datos de train y test:
write.table(trainetometeo_train_norm_lm1, 
  "data_pruebas/trainetometeo_train_norm_lm1.txt", 
  sep=",", dec=".", row.names=FALSE)
write.table(trainetometeo_test_norm_lm1, 
  "data_pruebas/trainetometeo_test_norm_lm1.txt", 
  sep=",", dec=".", row.names=FALSE)

write.table(trainetometeo_train_log_norm_lm2, 
  "data_pruebas/trainetometeo_train_log_norm_lm2.txt", 
  sep=",", dec=".", row.names=FALSE)
write.table(trainetometeo_test_log_norm_lm2, 
  "data_pruebas/trainetometeo_test_log_norm_lm2.txt", 
  sep=",", dec=".", row.names=FALSE)
```
...
?? Poner una captura de los modelos para explicar que nos quedamos con el trainetometeo_train_norm la segunda correlación que sería: trainetometeo_train_log_norm_corr2

?? Tenemos que explicar que para basarnos en los datos de la correlación hemos utilizado los datos en log pero que a la hora de seleccionar las variables en el conjunto de datos le hemos quitado el log para no perder la interpretación de los datos y puede ser menos útil cuando se desea comparar las relaciones relativas entre las variables.

?? Una vez decidamos cuáles son los procesos de selección de características que nos producen mejores resultados. Podemos decir definitvamente que es el siguiente:
